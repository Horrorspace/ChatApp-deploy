...
(function (socketEvents) {
    socketEvents["setOnline"] = "set_online";
    socketEvents["test"] = "test";
})(socketEvents || (socketEvents = {}));
let UsersGateway = class UsersGateway {
    handleSetOnline({ test }) {
        console.log(test);
        this.test();
    }
    test() {
...
__decorate([
    (0, websockets_1.SubscribeMessage)(socketEvents.test),
    __param(0, (0, websockets_1.MessageBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], UsersGateway.prototype, "handleSetOnline", null);
